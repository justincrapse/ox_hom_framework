...
class ConvertheightfieldNode(OXNode):
    ...
    parm_lookup_dict = {'layer': 'layer', 'conversion': 'conversion', 'surftype': 'surftype', 'lod': 'lod', 'bakecd': 'bakecd', 'folder0': 'folder0', 'doextrude': 'doextrude', 'depth': 'depth', 'basenormalx': 'basenormalx', 'basenormaly': 'basenormaly', 'basenormalz': 'basenormalz', 'flat': 'flat'}
