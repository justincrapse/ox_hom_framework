...
class RscolorcorrectionNode(OXNode):
    ...
    parm_lookup_dict = {'inputr': 'inputr', 'inputg': 'inputg', 'inputb': 'inputb', 'inputa': 'inputa', 'gamma': 'gamma', 'contrast': 'contrast', 'hue': 'hue', 'saturation': 'saturation', 'level': 'level', 'updatedmode': 'updatedMode', 'xsimode': 'xsiMode', 'shader_skipdefvalparms': 'shader_skipdefvalparms'}
