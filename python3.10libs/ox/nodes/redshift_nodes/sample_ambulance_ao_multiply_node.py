...
class SampleAmbulanceAoMultiplyNode(OXNode):
    ...
    def __init__(self, node=None, ox_parent=None, node_name=None):
        ...
        # parm menu vars:
        self.parm_layer1_blend_mode = Layer1BlendModeMenu(parm=self.node.parm('layer1_blend_mode'))
        self.parm_layer1_overlay_mode = Layer1OverlayModeMenu(parm=self.node.parm('layer1_overlay_mode'))
        self.parm_layer2_blend_mode = Layer2BlendModeMenu(parm=self.node.parm('layer2_blend_mode'))
        self.parm_layer2_overlay_mode = Layer2OverlayModeMenu(parm=self.node.parm('layer2_overlay_mode'))
        self.parm_layer3_blend_mode = Layer3BlendModeMenu(parm=self.node.parm('layer3_blend_mode'))
        self.parm_layer3_overlay_mode = Layer3OverlayModeMenu(parm=self.node.parm('layer3_overlay_mode'))
        self.parm_layer4_blend_mode = Layer4BlendModeMenu(parm=self.node.parm('layer4_blend_mode'))
        self.parm_layer4_overlay_mode = Layer4OverlayModeMenu(parm=self.node.parm('layer4_overlay_mode'))
        self.parm_layer5_blend_mode = Layer5BlendModeMenu(parm=self.node.parm('layer5_blend_mode'))
        self.parm_layer5_overlay_mode = Layer5OverlayModeMenu(parm=self.node.parm('layer5_overlay_mode'))
        self.parm_layer6_blend_mode = Layer6BlendModeMenu(parm=self.node.parm('layer6_blend_mode'))
        self.parm_layer6_overlay_mode = Layer6OverlayModeMenu(parm=self.node.parm('layer6_overlay_mode'))
        self.parm_layer7_blend_mode = Layer7BlendModeMenu(parm=self.node.parm('layer7_blend_mode'))
        self.parm_layer7_overlay_mode = Layer7OverlayModeMenu(parm=self.node.parm('layer7_overlay_mode'))
