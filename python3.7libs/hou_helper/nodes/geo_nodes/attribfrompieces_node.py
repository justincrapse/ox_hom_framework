...
class NoisebasisMenu(Menu):
    def __init__(self, parm):
        self.parm = parm
        super().__init__(parm=parm)
        self.value_noise___fast = 0
        self.value_noise___sparse_convolution = 1
        self.value_noise___alligator = 2
        self.perlin = 3
        self.perlin___flow = 4
        self.simplex = 5
        self.worley_cellular___f1 = 6
        self.worley_cellular___f2_f1 = 7
        self.worley_cellular___manhattan_f1 = 8
        self.worley_cellular___manhattan_f2_f1 = 9
        self.worley_cellular___chebyshev_f1 = 10
        self.worley_cellular___chebyshev_f2_f1 = 11
