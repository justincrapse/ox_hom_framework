...
class HeightfieldMaskbyfeatureNode(HHNode):
    ...
    def __init__(self, node=None, hh_parent=None, node_name=None):
        ...
        self.parm_sloperamp4interp_menu = Sloperamp4InterpMenu(parm=self.node.parm('sloperamp4interp'))
        self.parm_heightramp1interp_menu = Heightramp1InterpMenu(parm=self.node.parm('heightramp1interp'))
        self.parm_heightramp2interp_menu = Heightramp2InterpMenu(parm=self.node.parm('heightramp2interp'))
        self.parm_heightramp3interp_menu = Heightramp3InterpMenu(parm=self.node.parm('heightramp3interp'))
        self.parm_heightramp4interp_menu = Heightramp4InterpMenu(parm=self.node.parm('heightramp4interp'))
        self.parm_curvatureramp1interp_menu = Curvatureramp1InterpMenu(parm=self.node.parm('curvatureramp1interp'))
        self.parm_curvatureramp2interp_menu = Curvatureramp2InterpMenu(parm=self.node.parm('curvatureramp2interp'))
        self.parm_curvatureramp3interp_menu = Curvatureramp3InterpMenu(parm=self.node.parm('curvatureramp3interp'))
        self.parm_curvatureramp4interp_menu = Curvatureramp4InterpMenu(parm=self.node.parm('curvatureramp4interp'))
        self.parm_dirramp1interp_menu = Dirramp1InterpMenu(parm=self.node.parm('dirramp1interp'))
        self.parm_dirramp2interp_menu = Dirramp2InterpMenu(parm=self.node.parm('dirramp2interp'))
        self.parm_dirramp3interp_menu = Dirramp3InterpMenu(parm=self.node.parm('dirramp3interp'))
        self.parm_dirramp4interp_menu = Dirramp4InterpMenu(parm=self.node.parm('dirramp4interp'))
        ...
        # input vars:
        self.input_terrain_to_create_mask_on = 0
