...
class MatchsizeNode(OXNode):
    node_type = 'matchsize'
    parm_lookup_dict = {'restorexform': 'restorexform', 'restoreattrib': 'restoreattrib', 'folder0': 'folder0', 'dotranslate': 'dotranslate', 'tx': 'tx', 'ty': 'ty', 'tz': 'tz', 'justify_x': 'justify_x', 'justify_y': 'justify_y', 'justify_z': 'justify_z', 'doscale': 'doscale', 'sizex': 'sizex', 'sizey': 'sizey', 'sizez': 'sizez', 'uniformscale': 'uniformscale', 'scale_axis': 'scale_axis', 'scale_x': 'scale_x', 'scale_y': 'scale_y', 'scale_z': 'scale_z', 'stashxform': 'stashxform', 'stashattrib': 'stashattrib', 'stashmerge': 'stashmerge'}
