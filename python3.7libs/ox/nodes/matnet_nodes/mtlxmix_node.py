...
class MtlxmixNode(OXNode):
    node_type = 'mtlxmix'
    parm_lookup_dict = {'signature': 'signature', 'fg': 'fg', 'bg': 'bg', 'mix': 'mix', 'fg_bsdf': 'fg_bsdf', 'bg_bsdf': 'bg_bsdf', 'fg_color3r': 'fg_color3r', 'fg_color3g': 'fg_color3g', 'fg_color3b': 'fg_color3b', 'bg_color3r': 'bg_color3r', 'bg_color3g': 'bg_color3g', 'bg_color3b': 'bg_color3b', 'fg_color4r': 'fg_color4r', 'fg_color4g': 'fg_color4g', 'fg_color4b': 'fg_color4b', 'fg_color4a': 'fg_color4a', 'bg_color4r': 'bg_color4r', 'bg_color4g': 'bg_color4g', 'bg_color4b': 'bg_color4b', 'bg_color4a': 'bg_color4a', 'fg_displacementshader': 'fg_displacementshader', 'bg_displacementshader': 'bg_displacementshader', 'fg_edf': 'fg_edf', 'bg_edf': 'bg_edf', 'fg_surfaceshader': 'fg_surfaceshader', 'bg_surfaceshader': 'bg_surfaceshader', 'fg_vdf': 'fg_vdf', 'bg_vdf': 'bg_vdf', 'fg_vector2x': 'fg_vector2x', 'fg_vector2y': 'fg_vector2y', 'bg_vector2x': 'bg_vector2x', 'bg_vector2y': 'bg_vector2y', 'fg_vector3x': 'fg_vector3x', 'fg_vector3y': 'fg_vector3y', 'fg_vector3z': 'fg_vector3z', 'bg_vector3x': 'bg_vector3x', 'bg_vector3y': 'bg_vector3y', 'bg_vector3z': 'bg_vector3z', 'fg_vector4x': 'fg_vector4x', 'fg_vector4y': 'fg_vector4y', 'fg_vector4z': 'fg_vector4z', 'fg_vector4w': 'fg_vector4w', 'bg_vector4x': 'bg_vector4x', 'bg_vector4y': 'bg_vector4y', 'bg_vector4z': 'bg_vector4z', 'bg_vector4w': 'bg_vector4w', 'fg_volumeshader': 'fg_volumeshader', 'bg_volumeshader': 'bg_volumeshader'}
    ...
    def __init__(self, node=None, ox_parent=None, node_name=None):
        ...
        self.parm_fg_displacementshader = Parameter(parm=self.node.parm('fg_displacementshader'))
        self.parm_bg_displacementshader = Parameter(parm=self.node.parm('bg_displacementshader'))
...
class SignatureMenu(Menu):
    def __init__(self, parm):
        ...
        self.menu_surface_shader = 'surfaceshader'
