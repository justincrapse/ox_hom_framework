...
class AlembicNode(OXNode):
    node_type = 'alembic'
    parm_lookup_dict = {'reload': 'reload', 'numlayers': 'numlayers', 'filename': 'fileName', 'frame': 'frame', 'fps': 'fps', 'missingfile': 'missingfile', 'stdswitcher1': 'stdswitcher1', 'abcxform': 'abcxform', 'loadmode': 'loadmode', 'viewportlod': 'viewportlod', 'pointmode': 'pointmode', 'polysoup': 'polysoup', 'includexform': 'includeXform', 'usevisibility': 'usevisibility', 'statictimezero': 'statictimezero', 'groupnames': 'groupnames', 'subdgroup': 'subdgroup', 'rootpath': 'rootPath', 'pickrootpath': 'pickrootPath', 'objectpath': 'objectPath', 'pickobjectpath': 'pickobjectPath', 'objectexclude': 'objectExclude', 'pickobjectexclude': 'pickobjectExclude', 'objectpattern': 'objectPattern', 'animationfilter': 'animationfilter', 'polygonfilter': 'polygonFilter', 'curvefilter': 'curveFilter', 'nurbsfilter': 'NURBSFilter', 'pointsfilter': 'pointsFilter', 'subdfilter': 'subdFilter', 'loadlocator': 'loadLocator', 'boxcull': 'boxcull', 'boxsource': 'boxsource', 'boxsizex': 'boxsizex', 'boxsizey': 'boxsizey', 'boxsizez': 'boxsizez', 'boxcenterx': 'boxcenterx', 'boxcentery': 'boxcentery', 'boxcenterz': 'boxcenterz', 'sizecull': 'sizecull', 'sizecompare': 'sizecompare', 'size': 'size', 'pointattributes': 'pointAttributes', 'vertexattributes': 'vertexAttributes', 'primitiveattributes': 'primitiveAttributes', 'detailattributes': 'detailAttributes', 'facesetattributes': 'facesetAttributes', 'loaduserprops': 'loadUserProps', 'addpath': 'addpath', 'pathattrib': 'pathattrib', 'addfile': 'addfile', 'fileattrib': 'fileattrib', 'remapattributes': 'remapAttributes'}
    ...
    def __init__(self, node=None, ox_parent=None, node_name=None):
        ...
        self.parm_pickobjectexclude = Parameter(parm=self.node.parm('pickobjectExclude'))
        ...
        self.parm_primitiveattributes = Parameter(parm=self.node.parm('primitiveAttributes'))
        self.parm_detailattributes = Parameter(parm=self.node.parm('detailAttributes'))
        self.parm_facesetattributes = Parameter(parm=self.node.parm('facesetAttributes'))
        ...
        self.parm_objectexclude = ObjectexcludeMenu(parm=self.node.parm('objectExclude'))
        self.parm_animationfilter = AnimationfilterMenu(parm=self.node.parm('animationfilter'))
        ...
        self.parm_loaduserprops = LoaduserpropsMenu(parm=self.node.parm('loadUserProps'))
