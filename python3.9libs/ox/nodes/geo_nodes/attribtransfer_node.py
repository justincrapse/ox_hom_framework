...
class AttribtransferNode(OXNode):
    ...
    parm_lookup_dict = {
        "srcgroups": "srcgroups",
        "srcgrouptype": "srcgrouptype",
        "dstgroups": "dstgroups",
        "dstgrouptype": "dstgrouptype",
        "cardswitcher1": "cardswitcher1",
        "detailattribs": "detailattribs",
        "detailattriblist": "detailattriblist",
        "primitiveattribs": "primitiveattribs",
        "primattriblist": "primattriblist",
        "pointattribs": "pointattribs",
        "pointattriblist": "pointattriblist",
        "vertexattribs": "vertexattribs",
        "vertexattriblist": "vertexattriblist",
        "copyvariable": "copyvariable",
        "matchpattrib": "matchpattrib",
        "kernel": "kernel",
    ...
    def __init__(self, node=None, ox_parent=None, node_name=None):
        ...
        # input vars:
        self.input_geometry_to_transfer_attributes_to = (
            "Geometry to transfer attributes to"
        )
        self.input_geometry_to_transfer_attributes_from = (
            "Geometry to transfer attributes from"
        )
