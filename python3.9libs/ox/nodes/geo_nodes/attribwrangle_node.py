...
class AttribwrangleNode(OXNode):
    ...
    parm_lookup_dict = {
        ...
        "grouptype": "grouptype",
        "class_alt": "class",
        "vex_numcount": "vex_numcount",
        "vex_threadjobsize": "vex_threadjobsize",
        "snippet": "snippet",
        "exportlist": "exportlist",
        "vex_strict": "vex_strict",
        "autobind": "autobind",
        "bindings": "bindings",
        "groupautobind": "groupautobind",
        "groupbindings": "groupbindings",
        "vex_cwdpath": "vex_cwdpath",
        "vex_outputmask": "vex_outputmask",
        "vex_updatenmls": "vex_updatenmls",
        "vex_matchattrib": "vex_matchattrib",
        "vex_inplace": "vex_inplace",
        "vex_selectiongroup": "vex_selectiongroup",
    ...
    def __init__(self, node=None, ox_parent=None, node_name=None):
        ...
        self.parm_vex_threadjobsize = Parameter(
            parm=self.node.parm("vex_threadjobsize")
        )
        ...
        self.parm_vex_selectiongroup = Parameter(
            parm=self.node.parm("vex_selectiongroup")
        )
        ...
        self.input_ancillary_input__point_1_______to_access = (
            "Ancillary Input, point(1, ...) to Access"
        )
        self.input_ancillary_input__point_2_______to_access = (
            "Ancillary Input, point(2, ...) to Access"
        )
        self.input_ancillary_input__point_3_______to_access = (
