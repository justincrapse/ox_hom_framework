...
class BooleanNode(OXNode):
    ...
    parm_lookup_dict = {
        ...
        "output": "output",
        "booleanop": "booleanop",
        "subtractchoices": "subtractchoices",
        "shatterchoices": "shatterchoices",
        "opencurvesonly": "opencurvesonly",
        "generateaaseams": "generateaaseams",
        "generatebbseams": "generatebbseams",
        "generateabseams": "generateabseams",
        "adepth1": "adepth1",
        "adepth2": "adepth2",
        "bdepth1": "bdepth1",
        "bdepth2": "bdepth2",
        "windingop": "windingop",
        "mergenbrs": "mergenbrs",
        "detriangulate": "detriangulate",
        "removeinlinepoints": "removeinlinepoints",
        "uniqueseams": "uniqueseams",
        "correctnormals": "correctnormals",
        "useaxapolys": "useaxapolys",
        "axapolys": "axapolys",
        "useaxbpolys": "useaxbpolys",
        "axbpolys": "axbpolys",
        "useaxalist": "useaxalist",
        "axalist": "axalist",
        "useaxblist": "useaxblist",
        "axblist": "axblist",
        "collapsetinyedges": "collapsetinyedges",
        "lengththreshold": "lengththreshold",
        "outputprimgroups": "outputprimgroups",
        "useapolys": "useapolys",
        "apolys": "apolys",
        "useainsideb": "useainsideb",
        "ainsideb": "ainsideb",
        "useaoutsideb": "useaoutsideb",
        "aoutsideb": "aoutsideb",
        "usebpolys": "usebpolys",
        "bpolys": "bpolys",
        "usebinsidea": "usebinsidea",
        "binsidea": "binsidea",
        "useboutsidea": "useboutsidea",
        "boutsidea": "boutsidea",
        "useaboverlap": "useaboverlap",
        "aboverlap": "aboverlap",
        "useaonlypieces": "useaonlypieces",
        "aonlypieces": "aonlypieces",
        "usebonlypieces": "usebonlypieces",
        "bonlypieces": "bonlypieces",
        "useabpieces": "useabpieces",
        "abpieces": "abpieces",
        "usereversedpolys": "usereversedpolys",
        "reversedpolys": "reversedpolys",
        "outputedgegroups": "outputedgegroups",
        "useaaseamedges": "useaaseamedges",
        "aaseamedges": "aaseamedges",
        "usebbseamedges": "usebbseamedges",
        "bbseamedges": "bbseamedges",
        "useabseamedges": "useabseamedges",
        "abseamedges": "abseamedges",
    }
    ...
    def __init__(self, node=None, ox_parent=None, node_name=None):
        ...
        self.parm_removeinlinepoints = Parameter(
            parm=self.node.parm("removeinlinepoints")
        )
        ...
        self.parm_collapsetinyedges = Parameter(
            parm=self.node.parm("collapsetinyedges")
        )
        ...
        self.parm_subtractchoices = SubtractchoicesMenu(
            parm=self.node.parm("subtractchoices")
        )
        self.parm_shatterchoices = ShatterchoicesMenu(
            parm=self.node.parm("shatterchoices")
        )
        self.parm_windingop = WindingopMenu(parm=self.node.parm("windingop"))
        self.parm_detriangulate = DetriangulateMenu(
            parm=self.node.parm("detriangulate")
        )
