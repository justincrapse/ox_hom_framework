...
class CleanNode(OXNode):
    ...
    parm_lookup_dict = {
        "fusepts": "fusepts",
        "deldegengeo": "deldegengeo",
        "degentol": "degentol",
        "removeunusedgrp": "removeunusedgrp",
        "orientpoly": "orientpoly",
        "reversewinding": "reversewinding",
        "fixoverlap": "fixoverlap",
        "deleteoverlap": "deleteoverlap",
        "delunusedpts": "delunusedpts",
        "dodelattribs": "dodelattribs",
        "delattribs": "delattribs",
        "dodelgroups": "dodelgroups",
        "delgroups": "delgroups",
        "delnans": "delnans",
