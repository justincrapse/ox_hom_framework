...
class CopytopointsNode(OXNode):
    ...
    parm_lookup_dict = {
        ...
        "useidattrib": "useidattrib",
        "idattrib": "idattrib",
        "pack": "pack",
        "pivot": "pivot",
        "viewportlod": "viewportlod",
        "transform": "transform",
        "useimplicitn": "useimplicitn",
        "resettargetattribs": "resettargetattribs",
    ...
    def __init__(self, node=None, ox_parent=None, node_name=None):
        ...
        self.parm_resettargetattribs = Parameter(
            parm=self.node.parm("resettargetattribs")
        )
