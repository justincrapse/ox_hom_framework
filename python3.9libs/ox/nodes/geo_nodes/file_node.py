...
class FileNode(OXNode):
    ...
    parm_lookup_dict = {
        ...
        "geodatapath": "geodatapath",
        "missingframe": "missingframe",
        "loadtype": "loadtype",
        "packedviewedit": "packedviewedit",
    ...
    def __init__(self, node=None, ox_parent=None, node_name=None):
        ...
        self.parm_packedviewedit = PackedvieweditMenu(
            parm=self.node.parm("packedviewedit")
        )
...
class FileMenu(Menu):
    def __init__(self, parm):
        self.parm = parm
        super().__init__(parm=parm)
        self.menu_d__art_projects____che1__f4_bgeo_sc = (
            "D:/ART/PROJECTS/NEBULA/geo/NEBULA_supercharged_wist.filecache1/NEBULA_supercharged_wist.filecache1.$F4.bgeo.sc",
            0,
        )
        self.menu__hip_statue_bgeo_sc = ("$HIP/statue.bgeo.sc", 1)
        self.menu_e__art_projects____geo_upgraded_abc = (
            "E:/ART/PROJECTS/sword/full_sword_geo_upgraded.abc",
            2,
        )
        self.menu_e__art_projects____ll_sword_geo_abc = (
            "E:/ART/PROJECTS/sword/full_sword_geo.abc",
            3,
        )
        self.menu_e__art_projects____l_sword_geo_bgeo = (
            "E:/ART/PROJECTS/sword/full_sword_geo.bgeo",
            4,
        )
