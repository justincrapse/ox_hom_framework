...
class FileMenu(Menu):
    def __init__(self, parm):
        self.parm = parm
        super().__init__(parm=parm)
        self.menu_d__art_projects____he2_0071_bgeo_sc = ("D:/ART/PROJECTS/NEBULA/geo/NEBULA_supercharged_wist.filecache2/NEBULA_supercharged_wist.filecache2.0071.bgeo.sc", 0)
        self.menu_d__art_products_____pine_trees_bgeo = ("D:/ART/PRODUCTS/OX-TREES/tree_assets/pine_trees.bgeo", 1)
        self.menu_d__art_projects____che1__f4_bgeo_sc = ("D:/ART/PROJECTS/NEBULA/geo/NEBULA_supercharged_wist.filecache1/NEBULA_supercharged_wist.filecache1.$F4.bgeo.sc", 2)
        self.menu__hip_statue_bgeo_sc = ("$HIP/statue.bgeo.sc", 3)
        self.menu_e__art_projects____geo_upgraded_abc = ("E:/ART/PROJECTS/sword/full_sword_geo_upgraded.abc", 4)
        self.menu_e__art_projects____ll_sword_geo_abc = ("E:/ART/PROJECTS/sword/full_sword_geo.abc", 5)
        self.menu_e__art_projects____l_sword_geo_bgeo = ("E:/ART/PROJECTS/sword/full_sword_geo.bgeo", 6)
