...
class HeightfieldMaskbyfeatureNode(OXNode):
    ...
    parm_lookup_dict = {
        ...
        "folder1": "folder1",
        "maskbyslope": "maskbyslope",
        "min_slopeangle": "min_slopeangle",
        "max_slopeangle": "max_slopeangle",
        "sloperamp": "sloperamp",
        "folder2": "folder2",
        "maskbyheight": "maskbyheight",
        "computerange": "computerange",
        "minheight": "minheight",
        "maxheight": "maxheight",
        "heightramp": "heightramp",
        "folder4": "folder4",
        "maskbycurvature": "maskbycurvature",
        "computercurvature": "computercurvature",
        "max_curvature": "max_curvature",
        "curvatureramp": "curvatureramp",
        "folder0": "folder0",
        "maskbydir": "maskbydir",
        ...
        "dirramp": "dirramp",
        "folder5": "folder5",
        "maskbyocclusion": "maskbyocclusion",
        ...
        "masklayer": "masklayer",
        "sloperamp1pos": "sloperamp1pos",
        "sloperamp1value": "sloperamp1value",
        "sloperamp1interp": "sloperamp1interp",
        "sloperamp2pos": "sloperamp2pos",
        "sloperamp2value": "sloperamp2value",
        "sloperamp2interp": "sloperamp2interp",
        "sloperamp3pos": "sloperamp3pos",
        "sloperamp3value": "sloperamp3value",
        "sloperamp3interp": "sloperamp3interp",
        "sloperamp4pos": "sloperamp4pos",
        "sloperamp4value": "sloperamp4value",
        "sloperamp4interp": "sloperamp4interp",
        "heightramp1pos": "heightramp1pos",
        "heightramp1value": "heightramp1value",
        "heightramp1interp": "heightramp1interp",
        "heightramp2pos": "heightramp2pos",
        "heightramp2value": "heightramp2value",
        "heightramp2interp": "heightramp2interp",
        "heightramp3pos": "heightramp3pos",
        "heightramp3value": "heightramp3value",
        "heightramp3interp": "heightramp3interp",
        "heightramp4pos": "heightramp4pos",
        "heightramp4value": "heightramp4value",
        "heightramp4interp": "heightramp4interp",
        "curvatureramp1pos": "curvatureramp1pos",
        "curvatureramp1value": "curvatureramp1value",
        "curvatureramp1interp": "curvatureramp1interp",
        "curvatureramp2pos": "curvatureramp2pos",
        "curvatureramp2value": "curvatureramp2value",
        "curvatureramp2interp": "curvatureramp2interp",
        "curvatureramp3pos": "curvatureramp3pos",
        "curvatureramp3value": "curvatureramp3value",
        "curvatureramp3interp": "curvatureramp3interp",
        "curvatureramp4pos": "curvatureramp4pos",
        "curvatureramp4value": "curvatureramp4value",
        "curvatureramp4interp": "curvatureramp4interp",
        "dirramp1pos": "dirramp1pos",
        "dirramp1value": "dirramp1value",
        "dirramp1interp": "dirramp1interp",
        "dirramp2pos": "dirramp2pos",
        "dirramp2value": "dirramp2value",
        "dirramp2interp": "dirramp2interp",
        "dirramp3pos": "dirramp3pos",
        "dirramp3value": "dirramp3value",
        "dirramp3interp": "dirramp3interp",
        "dirramp4pos": "dirramp4pos",
        "dirramp4value": "dirramp4value",
        "dirramp4interp": "dirramp4interp",
        "ramp1pos": "ramp1pos",
    ...
    def __init__(self, node=None, ox_parent=None, node_name=None):
        ...
        self.parm_computercurvature = Parameter(
            parm=self.node.parm("computercurvature")
        )
        ...
        self.parm_curvatureramp1pos = Parameter(
            parm=self.node.parm("curvatureramp1pos")
        )
        self.parm_curvatureramp1value = Parameter(
            parm=self.node.parm("curvatureramp1value")
        )
        self.parm_curvatureramp2pos = Parameter(
            parm=self.node.parm("curvatureramp2pos")
        )
        self.parm_curvatureramp2value = Parameter(
            parm=self.node.parm("curvatureramp2value")
        )
        self.parm_curvatureramp3pos = Parameter(
            parm=self.node.parm("curvatureramp3pos")
        )
        self.parm_curvatureramp3value = Parameter(
            parm=self.node.parm("curvatureramp3value")
        )
        self.parm_curvatureramp4pos = Parameter(
            parm=self.node.parm("curvatureramp4pos")
        )
        self.parm_curvatureramp4value = Parameter(
            parm=self.node.parm("curvatureramp4value")
        )
        ...
        self.parm_sloperamp1interp = Sloperamp1InterpMenu(
            parm=self.node.parm("sloperamp1interp")
        )
        self.parm_sloperamp2interp = Sloperamp2InterpMenu(
            parm=self.node.parm("sloperamp2interp")
        )
        self.parm_sloperamp3interp = Sloperamp3InterpMenu(
            parm=self.node.parm("sloperamp3interp")
        )
        self.parm_sloperamp4interp = Sloperamp4InterpMenu(
            parm=self.node.parm("sloperamp4interp")
        )
        self.parm_heightramp1interp = Heightramp1InterpMenu(
            parm=self.node.parm("heightramp1interp")
        )
        self.parm_heightramp2interp = Heightramp2InterpMenu(
            parm=self.node.parm("heightramp2interp")
        )
        self.parm_heightramp3interp = Heightramp3InterpMenu(
            parm=self.node.parm("heightramp3interp")
        )
        self.parm_heightramp4interp = Heightramp4InterpMenu(
            parm=self.node.parm("heightramp4interp")
        )
        self.parm_curvatureramp1interp = Curvatureramp1InterpMenu(
            parm=self.node.parm("curvatureramp1interp")
        )
        self.parm_curvatureramp2interp = Curvatureramp2InterpMenu(
            parm=self.node.parm("curvatureramp2interp")
        )
        self.parm_curvatureramp3interp = Curvatureramp3InterpMenu(
            parm=self.node.parm("curvatureramp3interp")
        )
        self.parm_curvatureramp4interp = Curvatureramp4InterpMenu(
            parm=self.node.parm("curvatureramp4interp")
        )
        self.parm_dirramp1interp = Dirramp1InterpMenu(
            parm=self.node.parm("dirramp1interp")
        )
        self.parm_dirramp2interp = Dirramp2InterpMenu(
            parm=self.node.parm("dirramp2interp")
        )
        self.parm_dirramp3interp = Dirramp3InterpMenu(
            parm=self.node.parm("dirramp3interp")
        )
        self.parm_dirramp4interp = Dirramp4InterpMenu(
            parm=self.node.parm("dirramp4interp")
        )
