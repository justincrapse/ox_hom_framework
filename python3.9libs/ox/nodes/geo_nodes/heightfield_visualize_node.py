...
class HeightfieldVisualizeNode(OXNode):
    ...
    parm_lookup_dict = {
        "folder0": "folder0",
        "updatetinting": "updatetinting",
        "heightvolume": "heightvolume",
        "cdvolume": "cdvolume",
        "computerange": "computerange",
        "cdrangeoverride": "cdrangeoverride",
        "cdrange1": "cdrange1",
        "cdrange2": "cdrange2",
        "cdrampmode": "cdrampmode",
        "cdpreset": "cdpreset",
        "cdramp": "cdramp",
        "folder1": "folder1",
        "updatematerial": "updatematerial",
        "vis_projection": "vis_projection",
        "computerange2": "computerange2",
        "vis_minelevation": "vis_minelevation",
        "vis_maxelevation": "vis_maxelevation",
        "vis_heightramp": "vis_heightramp",
        "vis_layer9": "vis_layer9",
        "vis_color9r": "vis_color9r",
        "vis_color9g": "vis_color9g",
        "vis_color9b": "vis_color9b",
        "vis_color9a": "vis_color9a",
        "vis_layer8": "vis_layer8",
        "vis_color8r": "vis_color8r",
        "vis_color8g": "vis_color8g",
        "vis_color8b": "vis_color8b",
        "vis_color8a": "vis_color8a",
        "vis_layer7": "vis_layer7",
        "vis_color7r": "vis_color7r",
        "vis_color7g": "vis_color7g",
        "vis_color7b": "vis_color7b",
        "vis_color7a": "vis_color7a",
        "vis_layer6": "vis_layer6",
        "vis_color6r": "vis_color6r",
        "vis_color6g": "vis_color6g",
        "vis_color6b": "vis_color6b",
        "vis_color6a": "vis_color6a",
        "vis_layer5": "vis_layer5",
        "vis_color5r": "vis_color5r",
        "vis_color5g": "vis_color5g",
        "vis_color5b": "vis_color5b",
        "vis_color5a": "vis_color5a",
        "vis_layer4": "vis_layer4",
        "vis_color4r": "vis_color4r",
        "vis_color4g": "vis_color4g",
        "vis_color4b": "vis_color4b",
        "vis_color4a": "vis_color4a",
        "vis_layer3": "vis_layer3",
        "vis_color3r": "vis_color3r",
        "vis_color3g": "vis_color3g",
        "vis_color3b": "vis_color3b",
        "vis_color3a": "vis_color3a",
        "vis_layer2": "vis_layer2",
        "vis_color2r": "vis_color2r",
        "vis_color2g": "vis_color2g",
        "vis_color2b": "vis_color2b",
        "vis_color2a": "vis_color2a",
        "vis_layer1": "vis_layer1",
        "vis_color1r": "vis_color1r",
        "vis_color1g": "vis_color1g",
        "vis_color1b": "vis_color1b",
        "vis_color1a": "vis_color1a",
        "cdramp1pos": "cdramp1pos",
        "cdramp1cr": "cdramp1cr",
        "cdramp1cg": "cdramp1cg",
        "cdramp1cb": "cdramp1cb",
        "cdramp1interp": "cdramp1interp",
        "cdramp2pos": "cdramp2pos",
        "cdramp2cr": "cdramp2cr",
        "cdramp2cg": "cdramp2cg",
        "cdramp2cb": "cdramp2cb",
        "cdramp2interp": "cdramp2interp",
        "vis_heightramp1pos": "vis_heightramp1pos",
        "vis_heightramp1cr": "vis_heightramp1cr",
        "vis_heightramp1cg": "vis_heightramp1cg",
        "vis_heightramp1cb": "vis_heightramp1cb",
        "vis_heightramp1interp": "vis_heightramp1interp",
        "vis_heightramp2pos": "vis_heightramp2pos",
        "vis_heightramp2cr": "vis_heightramp2cr",
        "vis_heightramp2cg": "vis_heightramp2cg",
        "vis_heightramp2cb": "vis_heightramp2cb",
        "vis_heightramp2interp": "vis_heightramp2interp",
        "vis_heightramp3pos": "vis_heightramp3pos",
        "vis_heightramp3cr": "vis_heightramp3cr",
        "vis_heightramp3cg": "vis_heightramp3cg",
        "vis_heightramp3cb": "vis_heightramp3cb",
        "vis_heightramp3interp": "vis_heightramp3interp",
        "vis_heightramp4pos": "vis_heightramp4pos",
        "vis_heightramp4cr": "vis_heightramp4cr",
        "vis_heightramp4cg": "vis_heightramp4cg",
        "vis_heightramp4cb": "vis_heightramp4cb",
        "vis_heightramp4interp": "vis_heightramp4interp",
        "vis_heightramp5pos": "vis_heightramp5pos",
        "vis_heightramp5cr": "vis_heightramp5cr",
        "vis_heightramp5cg": "vis_heightramp5cg",
        "vis_heightramp5cb": "vis_heightramp5cb",
        "vis_heightramp5interp": "vis_heightramp5interp",
    }
    ...
    def __init__(self, node=None, ox_parent=None, node_name=None):
        ...
        self.parm_vis_heightramp1pos = Parameter(
            parm=self.node.parm("vis_heightramp1pos")
        )
        self.parm_vis_heightramp1cr = Parameter(
            parm=self.node.parm("vis_heightramp1cr")
        )
        self.parm_vis_heightramp1cg = Parameter(
            parm=self.node.parm("vis_heightramp1cg")
        )
        self.parm_vis_heightramp1cb = Parameter(
            parm=self.node.parm("vis_heightramp1cb")
        )
        self.parm_vis_heightramp2pos = Parameter(
            parm=self.node.parm("vis_heightramp2pos")
        )
        self.parm_vis_heightramp2cr = Parameter(
            parm=self.node.parm("vis_heightramp2cr")
        )
        self.parm_vis_heightramp2cg = Parameter(
            parm=self.node.parm("vis_heightramp2cg")
        )
        self.parm_vis_heightramp2cb = Parameter(
            parm=self.node.parm("vis_heightramp2cb")
        )
        self.parm_vis_heightramp3pos = Parameter(
            parm=self.node.parm("vis_heightramp3pos")
        )
        self.parm_vis_heightramp3cr = Parameter(
            parm=self.node.parm("vis_heightramp3cr")
        )
        self.parm_vis_heightramp3cg = Parameter(
            parm=self.node.parm("vis_heightramp3cg")
        )
        self.parm_vis_heightramp3cb = Parameter(
            parm=self.node.parm("vis_heightramp3cb")
        )
        self.parm_vis_heightramp4pos = Parameter(
            parm=self.node.parm("vis_heightramp4pos")
        )
        self.parm_vis_heightramp4cr = Parameter(
            parm=self.node.parm("vis_heightramp4cr")
        )
        self.parm_vis_heightramp4cg = Parameter(
            parm=self.node.parm("vis_heightramp4cg")
        )
        self.parm_vis_heightramp4cb = Parameter(
            parm=self.node.parm("vis_heightramp4cb")
        )
        self.parm_vis_heightramp5pos = Parameter(
            parm=self.node.parm("vis_heightramp5pos")
        )
        self.parm_vis_heightramp5cr = Parameter(
            parm=self.node.parm("vis_heightramp5cr")
        )
        self.parm_vis_heightramp5cg = Parameter(
            parm=self.node.parm("vis_heightramp5cg")
        )
        self.parm_vis_heightramp5cb = Parameter(
            parm=self.node.parm("vis_heightramp5cb")
        )

        # parm menu vars:
        self.parm_updatetinting = UpdatetintingMenu(
            parm=self.node.parm("updatetinting")
        )
        ...
        self.parm_updatematerial = UpdatematerialMenu(
            parm=self.node.parm("updatematerial")
        )
        self.parm_vis_projection = VisProjectionMenu(
            parm=self.node.parm("vis_projection")
        )
        self.parm_cdramp1interp = Cdramp1InterpMenu(
            parm=self.node.parm("cdramp1interp")
        )
        self.parm_cdramp2interp = Cdramp2InterpMenu(
            parm=self.node.parm("cdramp2interp")
        )
        self.parm_vis_heightramp1interp = VisHeightramp1InterpMenu(
            parm=self.node.parm("vis_heightramp1interp")
        )
        self.parm_vis_heightramp2interp = VisHeightramp2InterpMenu(
            parm=self.node.parm("vis_heightramp2interp")
        )
        self.parm_vis_heightramp3interp = VisHeightramp3InterpMenu(
            parm=self.node.parm("vis_heightramp3interp")
        )
        self.parm_vis_heightramp4interp = VisHeightramp4InterpMenu(
            parm=self.node.parm("vis_heightramp4interp")
        )
        self.parm_vis_heightramp5interp = VisHeightramp5InterpMenu(
            parm=self.node.parm("vis_heightramp5interp")
        )
