...
class MatchsizeNode(OXNode):
    ...
    parm_lookup_dict = {
        "group": "group",
        "grouptype": "grouptype",
        "justifytarget": "justifytarget",
        "doboundgroup": "doboundgroup",
        "folder2": "folder2",
        "sourcegroup": "sourcegroup",
        "sourcegrouptype": "sourcegrouptype",
        "refgroup": "refgroup",
        "refgrouptype": "refgrouptype",
        "folder1": "folder1",
        "tx": "tx",
        "ty": "ty",
        "tz": "tz",
        ...
        "scale_y": "scale_y",
        "scale_z": "scale_z",
        "restorexform": "restorexform",
        "restoreattrib": "restoreattrib",
        "stashxform": "stashxform",
        "stashattrib": "stashattrib",
        "stashmerge": "stashmerge",
    }
    ...
    def __init__(self, node=None, ox_parent=None, node_name=None):
        ...
        self.parm_justifytarget = JustifytargetMenu(
            parm=self.node.parm("justifytarget")
        )
        self.parm_sourcegrouptype = SourcegrouptypeMenu(
            parm=self.node.parm("sourcegrouptype")
        )
        ...
        self.input_geometry_whose_bounding_box_is_to_be_matched = (
            "Geometry whose Bounding Box is to be matched"
        )
