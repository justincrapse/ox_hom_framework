...
class ScatterNode(OXNode):
    ...
    parm_lookup_dict = {
        ...
        "indepvoxel": "indepvoxel",
        "forcetotal": "forcetotal",
        "npts": "npts",
        "densityscale": "densityscale",
        "usedensityattrib": "usedensityattrib",
        "densityattrib": "densityattrib",
        "useareaattrib": "useareaattrib",
        "areaattrib": "areaattrib",
        "useareaforvolumes": "useareaforvolumes",
        "usedensitytexture": "usedensitytexture",
        "densitytexture": "densitytexture",
        "uvattrib": "uvattrib",
        "primcountattrib": "primcountattrib",
        "useemergencylimit": "useemergencylimit",
        "emergencylimit": "emergencylimit",
        "seed": "seed",
        "overrideprimseed": "overrideprimseed",
        "primseedattrib": "primseedattrib",
        "randomizeorder": "randomizeorder",
        "relaxpoints": "relaxpoints",
        "relaxiterations": "relaxiterations",
        "scaleradiiby": "scaleradiiby",
        "usemaxradius": "usemaxradius",
        "maxradius": "maxradius",
        "useprimnumattrib": "useprimnumattrib",
        "primnumattrib": "primnumattrib",
        "useprimuvwattrib": "useprimuvwattrib",
        "primuvwattrib": "primuvwattrib",
        "useoutputdensityattrib": "useoutputdensityattrib",
        "outputdensityattrib": "outputdensityattrib",
        "useoutputradiusattrib": "useoutputradiusattrib",
        "outputradiusattrib": "outputradiusattrib",
        "radiusintexturespace": "radiusintexturespace",
        "pointattribs": "pointattribs",
        "vertattribs": "vertattribs",
        "primattribs": "primattribs",
        "detailattribs": "detailattribs",
    }
    ...
    def __init__(self, node=None, ox_parent=None, node_name=None):
        ...
        self.parm_useareaforvolumes = Parameter(
            parm=self.node.parm("useareaforvolumes")
        )
        self.parm_usedensitytexture = Parameter(
            parm=self.node.parm("usedensitytexture")
        )
        ...
        self.parm_useoutputdensityattrib = Parameter(
            parm=self.node.parm("useoutputdensityattrib")
        )
        self.parm_outputdensityattrib = Parameter(
            parm=self.node.parm("outputdensityattrib")
        )
        self.parm_useoutputradiusattrib = Parameter(
            parm=self.node.parm("useoutputradiusattrib")
        )
        self.parm_outputradiusattrib = Parameter(
            parm=self.node.parm("outputradiusattrib")
        )
        self.parm_radiusintexturespace = Parameter(
            parm=self.node.parm("radiusintexturespace")
        )
        ...
        self.parm_densitytexture = DensitytextureMenu(
            parm=self.node.parm("densitytexture")
        )
