...
class TransformNode(OXNode):
    ...
    parm_lookup_dict = {
        ...
        "prexform_xord": "prexform_xOrd",
        "prexform_rord": "prexform_rOrd",
        "prexform_tx": "prexform_tx",
        "prexform_ty": "prexform_ty",
        "prexform_tz": "prexform_tz",
        "prexform_rx": "prexform_rx",
        "prexform_ry": "prexform_ry",
        "prexform_rz": "prexform_rz",
        "prexform_sx": "prexform_sx",
        "prexform_sy": "prexform_sy",
        "prexform_sz": "prexform_sz",
        "prexform_shear1": "prexform_shear1",
        "prexform_shear2": "prexform_shear2",
        "prexform_shear3": "prexform_shear3",
        "movecentroid": "movecentroid",
        "attribs": "attribs",
        "updatenmls": "updatenmls",
        "updateaffectednmls": "updateaffectednmls",
        "vlength": "vlength",
        "invertxform": "invertxform",
        "addattrib": "addattrib",
    ...
    def __init__(self, node=None, ox_parent=None, node_name=None):
        ...
        self.parm_parmgroup_pivotxform = Parameter(
            parm=self.node.parm("parmgroup_pivotxform")
        )
        ...
        self.parm_parmgroup_prexform = Parameter(
            parm=self.node.parm("parmgroup_prexform")
        )
        ...
        self.parm_updateaffectednmls = Parameter(
            parm=self.node.parm("updateaffectednmls")
        )
