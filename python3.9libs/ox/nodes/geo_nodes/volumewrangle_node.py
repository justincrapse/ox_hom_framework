...
class VolumewrangleNode(OXNode):
    ...
    parm_lookup_dict = {
        ...
        "autobind": "autobind",
        "bindings": "bindings",
        "vex_geometrygenerator": "vex_geometrygenerator",
        "vdb_signedflood": "vdb_signedflood",
    ...
    def __init__(self, node=None, ox_parent=None, node_name=None):
        ...
        self.parm_vex_geometrygenerator = Parameter(
            parm=self.node.parm("vex_geometrygenerator")
        )
        ...
        self.input_auxillary_input_1__access_with_volumesample_1______ = (
            "Auxillary Input 1, access with volumesample(1, ...)"
        )
        self.input_auxillary_input_2__access_with_volumesample_2______ = (
            "Auxillary Input 2, access with volumesample(2, ...)"
        )
        self.input_auxillary_input_3__access_with_volumesample_3______ = (
            "Auxillary Input 3, access with volumesample(3, ...)"
        )
