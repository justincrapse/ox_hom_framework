...
class MtlxdisplacementNode(OXNode):
    ...
    parm_lookup_dict = {
        ...
        "scale": "scale",
        "displacement_vector3x": "displacement_vector3x",
        "displacement_vector3y": "displacement_vector3y",
        "displacement_vector3z": "displacement_vector3z",
    }
    ...
    def __init__(self, node=None, ox_parent=None, node_name=None):
        ...
        self.parm_displacement_vector3x = Parameter(
            parm=self.node.parm("displacement_vector3x")
        )
        self.parm_displacement_vector3y = Parameter(
            parm=self.node.parm("displacement_vector3y")
        )
        self.parm_displacement_vector3z = Parameter(
            parm=self.node.parm("displacement_vector3z")
        )
