...
class MtlxstandardSurfaceNode(OXNode):
    ...
    parm_lookup_dict = {
        ...
        "transmission_scatterr": "transmission_scatterr",
        "transmission_scatterg": "transmission_scatterg",
        "transmission_scatterb": "transmission_scatterb",
        ...
        "subsurface_colorr": "subsurface_colorr",
        "subsurface_colorg": "subsurface_colorg",
        "subsurface_colorb": "subsurface_colorb",
        "subsurface_radiusr": "subsurface_radiusr",
        "subsurface_radiusg": "subsurface_radiusg",
        "subsurface_radiusb": "subsurface_radiusb",
        ...
        "coat_ior": "coat_IOR",
        "coat_normalx": "coat_normalx",
        "coat_normaly": "coat_normaly",
        "coat_normalz": "coat_normalz",
    ...
    def __init__(self, node=None, ox_parent=None, node_name=None):
        ...
        self.parm_specular_roughness = Parameter(
            parm=self.node.parm("specular_roughness")
        )
        self.parm_specular_ior = Parameter(parm=self.node.parm("specular_IOR"))
        self.parm_specular_anisotropy = Parameter(
            parm=self.node.parm("specular_anisotropy")
        )
        self.parm_specular_rotation = Parameter(
            parm=self.node.parm("specular_rotation")
        )
        self.parm_transmission = Parameter(parm=self.node.parm("transmission"))
        self.parm_transmission_colorr = Parameter(
            parm=self.node.parm("transmission_colorr")
        )
        self.parm_transmission_colorg = Parameter(
            parm=self.node.parm("transmission_colorg")
        )
        self.parm_transmission_colorb = Parameter(
            parm=self.node.parm("transmission_colorb")
        )
        self.parm_transmission_depth = Parameter(
            parm=self.node.parm("transmission_depth")
        )
        self.parm_transmission_scatterr = Parameter(
            parm=self.node.parm("transmission_scatterr")
        )
        self.parm_transmission_scatterg = Parameter(
            parm=self.node.parm("transmission_scatterg")
        )
        self.parm_transmission_scatterb = Parameter(
            parm=self.node.parm("transmission_scatterb")
        )
        self.parm_transmission_scatter_anisotropy = Parameter(
            parm=self.node.parm("transmission_scatter_anisotropy")
        )
        self.parm_transmission_dispersion = Parameter(
            parm=self.node.parm("transmission_dispersion")
        )
        self.parm_transmission_extra_roughness = Parameter(
            parm=self.node.parm("transmission_extra_roughness")
        )
        self.parm_subsurface = Parameter(parm=self.node.parm("subsurface"))
        self.parm_subsurface_colorr = Parameter(
            parm=self.node.parm("subsurface_colorr")
        )
        self.parm_subsurface_colorg = Parameter(
            parm=self.node.parm("subsurface_colorg")
        )
        self.parm_subsurface_colorb = Parameter(
            parm=self.node.parm("subsurface_colorb")
        )
        self.parm_subsurface_radiusr = Parameter(
            parm=self.node.parm("subsurface_radiusr")
        )
        self.parm_subsurface_radiusg = Parameter(
            parm=self.node.parm("subsurface_radiusg")
        )
        self.parm_subsurface_radiusb = Parameter(
            parm=self.node.parm("subsurface_radiusb")
        )
        self.parm_subsurface_scale = Parameter(parm=self.node.parm("subsurface_scale"))
        self.parm_subsurface_anisotropy = Parameter(
            parm=self.node.parm("subsurface_anisotropy")
        )
        ...
        self.parm_coat_affect_color = Parameter(
            parm=self.node.parm("coat_affect_color")
        )
        self.parm_coat_affect_roughness = Parameter(
            parm=self.node.parm("coat_affect_roughness")
        )
        self.parm_thin_film_thickness = Parameter(
            parm=self.node.parm("thin_film_thickness")
        )
