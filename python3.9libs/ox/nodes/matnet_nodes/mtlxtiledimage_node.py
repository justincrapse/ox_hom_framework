...
class MtlxtiledimageNode(OXNode):
    ...
    parm_lookup_dict = {
        ...
        "uvoffsetx": "uvoffsetx",
        "uvoffsety": "uvoffsety",
        "realworldimagesizex": "realworldimagesizex",
        "realworldimagesizey": "realworldimagesizey",
        "realworldtilesizex": "realworldtilesizex",
        "realworldtilesizey": "realworldtilesizey",
        "filtertype": "filtertype",
        "framerange": "framerange",
        "frameoffset": "frameoffset",
        "frameendaction": "frameendaction",
        "default_color3r": "default_color3r",
        "default_color3g": "default_color3g",
        "default_color3b": "default_color3b",
        "default_color4r": "default_color4r",
        "default_color4g": "default_color4g",
        "default_color4b": "default_color4b",
        "default_color4a": "default_color4a",
        "default_vector2x": "default_vector2x",
        "default_vector2y": "default_vector2y",
        "default_vector3x": "default_vector3x",
        "default_vector3y": "default_vector3y",
        "default_vector3z": "default_vector3z",
        "default_vector4x": "default_vector4x",
        "default_vector4y": "default_vector4y",
        "default_vector4z": "default_vector4z",
        "default_vector4w": "default_vector4w",
    }
    ...
    def __init__(self, node=None, ox_parent=None, node_name=None):
        ...
        self.parm_realworldimagesizex = Parameter(
            parm=self.node.parm("realworldimagesizex")
        )
        self.parm_realworldimagesizey = Parameter(
            parm=self.node.parm("realworldimagesizey")
        )
        self.parm_realworldtilesizex = Parameter(
            parm=self.node.parm("realworldtilesizex")
        )
        self.parm_realworldtilesizey = Parameter(
            parm=self.node.parm("realworldtilesizey")
        )
