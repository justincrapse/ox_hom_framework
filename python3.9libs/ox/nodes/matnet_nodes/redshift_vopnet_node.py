...
class RedshiftVopnetNode(OXNode):
    node_type = "redshift_vopnet"
    parm_lookup_dict = {
        "redshift_shop_parmswitcher1": "Redshift_SHOP_parmSwitcher1",
        "rs_matprop_id": "RS_matprop_ID",
        "ogl_diffr": "ogl_diffr",
        "ogl_diffg": "ogl_diffg",
        "ogl_diffb": "ogl_diffb",
        "ogl_emitr": "ogl_emitr",
    ...
    def __init__(self, node=None, ox_parent=None, node_name=None):
        ...
        # parm vars:
        self.parm_redshift_shop_parmswitcher1 = Parameter(
            parm=self.node.parm("Redshift_SHOP_parmSwitcher1")
        )
