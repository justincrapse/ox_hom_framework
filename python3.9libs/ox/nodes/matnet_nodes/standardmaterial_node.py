...
class StandardmaterialNode(OXNode):
    ...
    parm_lookup_dict = {'rs_shadernodemainswitcher1': 'RS_shaderNodeMainSwitcher1', 'base_0': 'Base_0', 'base_colorr': 'base_colorr', 'base_colorg': 'base_colorg', 'base_colorb': 'base_colorb', 'base_color_weight': 'base_color_weight', 'diffuse_model': 'diffuse_model', 'diffuse_roughness': 'diffuse_roughness', 'metalness': 'metalness', 'reflection_1': 'Reflection_1', 'refl_colorr': 'refl_colorr', 'refl_colorg': 'refl_colorg', 'refl_colorb': 'refl_colorb', 'refl_weight': 'refl_weight', 'refl_roughness': 'refl_roughness', 'refl_ior': 'refl_ior', 'refl_aniso': 'refl_aniso', 'refl_aniso_rotation': 'refl_aniso_rotation', 'refl_samples': 'refl_samples', 'transmission_2': 'Transmission_2', 'refr_colorr': 'refr_colorr', 'refr_colorg': 'refr_colorg', 'refr_colorb': 'refr_colorb', 'refr_weight': 'refr_weight', 'refr_roughness': 'refr_roughness', 'refr_samples': 'refr_samples', 'ss_depth': 'ss_depth', 'ss_scatter_colorr': 'ss_scatter_colorr', 'ss_scatter_colorg': 'ss_scatter_colorg', 'ss_scatter_colorb': 'ss_scatter_colorb', 'ss_phase': 'ss_phase', 'ss_samples': 'ss_samples', 'refr_abbe': 'refr_abbe', 'subsurface_3': 'Subsurface_3', 'ms_colorr': 'ms_colorr', 'ms_colorg': 'ms_colorg', 'ms_colorb': 'ms_colorb', 'ms_amount': 'ms_amount', 'ms_radiusr': 'ms_radiusr', 'ms_radiusg': 'ms_radiusg', 'ms_radiusb': 'ms_radiusb', 'ms_radius_scale': 'ms_radius_scale', 'ms_phase': 'ms_phase', 'ms_mode': 'ms_mode', 'ms_samples': 'ms_samples', 'ms_include_mode': 'ms_include_mode', 'sheen_4': 'Sheen_4', 'sheen_colorr': 'sheen_colorr', 'sheen_colorg': 'sheen_colorg', 'sheen_colorb': 'sheen_colorb', 'sheen_weight': 'sheen_weight', 'sheen_roughness': 'sheen_roughness', 'sheen_samples': 'sheen_samples', 'thin_film_5': 'Thin_Film_5', 'thinfilm_ior': 'thinfilm_ior', 'thinfilm_thickness': 'thinfilm_thickness', 'coat_6': 'Coat_6', 'coat_colorr': 'coat_colorr', 'coat_colorg': 'coat_colorg', 'coat_colorb': 'coat_colorb', 'coat_weight': 'coat_weight', 'coat_roughness': 'coat_roughness', 'coat_ior': 'coat_ior', 'coat_aniso': 'coat_aniso', 'coat_aniso_rotation': 'coat_aniso_rotation', 'coat_samples': 'coat_samples', 'coat_bump_input': 'coat_bump_input', 'emission_7': 'Emission_7', 'emission_colorr': 'emission_colorr', 'emission_colorg': 'emission_colorg', 'emission_colorb': 'emission_colorb', 'emission_weight': 'emission_weight', 'geometry_8': 'Geometry_8', 'opacity_colorr': 'opacity_colorr', 'opacity_colorg': 'opacity_colorg', 'opacity_colorb': 'opacity_colorb', 'refr_thin_walled': 'refr_thin_walled', 'bump_input': 'bump_input', 'overall_colorr': 'overall_colorr', 'overall_colorg': 'overall_colorg', 'overall_colorb': 'overall_colorb', 'overallaffectsemission': 'overallAffectsEmission', 'depth_override': 'depth_override', 'combined_depth': 'combined_depth', 'reflection_9': 'Reflection_9', 'refl_depth': 'refl_depth', 'refl_enablecutoff': 'refl_enablecutoff', 'refl_cutoff': 'refl_cutoff', 'transmission_10': 'Transmission_10', 'refr_depth': 'refr_depth', 'refr_enablecutoff': 'refr_enablecutoff', 'refr_cutoff': 'refr_cutoff', 'refl_enablemultiscattercomp': 'refl_enableMultiScatterComp', 'diffuse_11': 'Diffuse_11', 'diffuse_direct': 'diffuse_direct', 'diffuse_indirect': 'diffuse_indirect', 'reflection_12': 'Reflection_12', 'refl_direct': 'refl_direct', 'refl_indirect': 'refl_indirect', 'refl_isglossiness': 'refl_isGlossiness', 'refl_endmode': 'refl_endmode', 'transmission_13': 'Transmission_13', 'shadow_opacity': 'shadow_opacity', 'refr_isglossiness': 'refr_isGlossiness', 'affects_alpha': 'affects_alpha', 'block_volumes': 'block_volumes', 'sheen_14': 'Sheen_14', 'sheen_direct': 'sheen_direct', 'sheen_indirect': 'sheen_indirect', 'sheen_isglossiness': 'sheen_isGlossiness', 'coat_15': 'Coat_15', 'coat_direct': 'coat_direct', 'coat_indirect': 'coat_indirect', 'coat_isglossiness': 'coat_isGlossiness', 'anisotropy_16': 'Anisotropy_16', 'anisotropy_orientation': 'anisotropy_orientation', 'anisotropy_uvchannel': 'anisotropy_uvChannel', 'anisotropy_tangentchannel': 'anisotropy_tangentChannel', 'shader_skipdefvalparms': 'shader_skipdefvalparms'}
    ...
    def __init__(self, node=None, ox_parent=None, node_name=None):
        ...
        self.parm_base_color_weight = Parameter(parm=self.node.parm('base_color_weight'))
        ...
        self.parm_ss_scatter_colorr = Parameter(parm=self.node.parm('ss_scatter_colorr'))
        self.parm_ss_scatter_colorg = Parameter(parm=self.node.parm('ss_scatter_colorg'))
        self.parm_ss_scatter_colorb = Parameter(parm=self.node.parm('ss_scatter_colorb'))
        ...
        self.parm_thinfilm_thickness = Parameter(parm=self.node.parm('thinfilm_thickness'))
        ...
        self.parm_coat_aniso_rotation = Parameter(parm=self.node.parm('coat_aniso_rotation'))
        ...
        self.parm_refl_enablemultiscattercomp = Parameter(parm=self.node.parm('refl_enableMultiScatterComp'))
