...
class RsObjpropAttrDetailMenu(Menu):
    def __init__(self, parm):
        self.parm = parm
        super().__init__(parm=parm)
        self.menu_volvis_emitscale = ("volvis_emitscale", 0)
        self.menu_volvis_cdramp = ("volvis_cdramp", 1)
        self.menu_volvis_shadowscale = ("volvis_shadowscale", 2)
        self.menu_volvis_emitramp = ("volvis_emitramp", 3)
        self.menu_volvis_emitcdrange = ("volvis_emitcdrange", 4)
        self.menu_volvis_densityrampperiodic = ("volvis_densityrampperiodic", 5)
        self.menu_volvis_emitrampperiodic = ("volvis_emitrampperiodic", 6)
        self.menu_volvis_emitcdramp = ("volvis_emitcdramp", 7)
        self.menu_volvis_cdrange = ("volvis_cdrange", 8)
        self.menu_volvis_densityramp = ("volvis_densityramp", 9)
        self.menu_volvis_emitrange = ("volvis_emitrange", 10)
        self.menu_volvis_densityrange = ("volvis_densityrange", 11)
        self.menu_volvis_emitcdfield = ("volvis_emitcdfield", 12)
        self.menu_volvis_emitcdrampperiodic = ("volvis_emitcdrampperiodic", 13)
        self.menu_volvis_cdfield = ("volvis_cdfield", 14)
        self.menu_volvis_emitfield = ("volvis_emitfield", 15)
        self.menu_volvis_cdrampperiodic = ("volvis_cdrampperiodic", 16)
        self.menu_volvis_densityfield = ("volvis_densityfield", 17)
