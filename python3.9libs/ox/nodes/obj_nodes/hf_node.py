...
class HfNode(OXNode):
    ...
    def __init__(self, node=None, ox_parent=None, node_name=None):
        ...
        self.parm_rs_objprop_attr_points = RsObjpropAttrPointsMenu(parm=self.node.parm('RS_objprop_attr_points'))
        self.parm_rs_objprop_attr_primitives = RsObjpropAttrPrimitivesMenu(parm=self.node.parm('RS_objprop_attr_primitives'))
        self.parm_rs_objprop_attr_detail = RsObjpropAttrDetailMenu(parm=self.node.parm('RS_objprop_attr_detail'))
        self.parm_rs_objprop_pckattr_replace = RsObjpropPckattrReplaceMenu(parm=self.node.parm('RS_objprop_pckattr_replace'))
        self.parm_rs_objprop_pckattr_mult = RsObjpropPckattrMultMenu(parm=self.node.parm('RS_objprop_pckattr_mult'))
        self.parm_rs_objprop_pckattr_add = RsObjpropPckattrAddMenu(parm=self.node.parm('RS_objprop_pckattr_add'))
...
class PickscriptMenu(Menu):
    def __init__(self, parm):
        self.parm = parm
        super().__init__(parm=parm)
        self.menu_e__renders_houdi___name__os__f4_exr = "E:/RENDERS/HOUDINI/TUTORIALS/MAGIC_RENDR/$HIPNAME.$OS.$F4.exr"
        self.menu_e__renders_houdi___r_magic_prev__f3 = "E:/RENDERS/HOUDINI/TUTORIALS/MAGIC_RENDR/magic_prev.$F3"
        self.menu_e__art_projects____y_first_hdrlight = "E:/ART/PROJECTS/00_shared/hdri/my_first_hdrlight"
