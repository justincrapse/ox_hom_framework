...
class RslightdomeNode(OXNode):
    ...
    parm_lookup_dict = {
        ...
        "dcolorb": "dcolorb",
        "folder01": "folder01",
        "folder1_21": "folder1_21",
        "l_iconscale": "l_iconscale",
        "folder3": "folder3",
        "light_enabled": "light_enabled",
        "on": "on",
        "ogl_enablelight": "ogl_enablelight",
        "rs_shadernodemainswitcher": "RS_shaderNodeMainSwitcher",
        "light_intensity": "light_intensity",
        "rsl_exposure": "RSL_exposure",
        "light_colorr": "light_colorr",
        "light_colorg": "light_colorg",
        "light_colorb": "light_colorb",
        "env_map": "env_map",
        "envtype": "envType",
        "tex0_colorspace": "tex0_colorSpace",
        "rsl_fliphorizontal": "RSL_flipHorizontal",
        "rsl_hue": "RSL_hue",
        "rsl_saturation": "RSL_saturation",
        "tex0_gamma": "tex0_gamma",
        "environment_alpha_channel_replace_2": "Environment_Alpha_Channel_Replace_2",
        "background_enable": "background_enable",
        "alphareplaceenable": "alphaReplaceEnable",
        "alphareplacevalue": "alphaReplaceValue",
        "rs_shadernodemainswitcher_1": "RS_shaderNodeMainSwitcher_1",
        "backplateenabled": "backPlateEnabled",
        "tex1": "tex1",
        "tex1_colorspace": "tex1_colorSpace",
        "tex1_gamma": "tex1_gamma",
        "rsl_exposure2": "RSL_exposure2",
        "rsl_hue2": "RSL_hue2",
        "rsl_saturation2": "RSL_saturation2",
        "backplateaspect": "backPlateAspect",
        "applyexposurecompensation": "applyExposureCompensation",
        "folder1": "folder1",
        "rsl_lightgroup": "RSL_lightGroup",
        "shadow_1": "Shadow_1",
        "shadow": "shadow",
        "shadowtransparency": "shadowTransparency",
        "folder2": "folder2",
        "rsl_affectdiffuse": "RSL_affectDiffuse",
        "rsl_affectspecular": "RSL_affectSpecular",
        "rsl_matteshadow": "RSL_matteShadow",
        "rsl_affectedbyrefraction": "RSL_affectedByRefraction",
        "rsl_indirectmaxtracedepth": "RSL_indirectMaxTraceDepth",
        "rsl_samples": "RSL_samples",
        "rsl_volumesamples": "RSL_volumeSamples",
        "rsl_diffusescale": "RSL_diffuseScale",
        "rsl_specularscale": "RSL_specularScale",
        "rsl_reflectionscale": "RSL_reflectionScale",
        "rsl_transmissionscale": "RSL_transmissionScale",
        "rsl_sssscale": "RSL_sssScale",
        "rsl_multisssscale": "RSL_multisssScale",
        "rsl_indirectscale": "RSL_indirectScale",
        "rsl_volumescale": "RSL_volumeScale",
        "folder5": "folder5",
        "folder7": "folder7",
        "rsl_emitcausticphotons": "RSL_emitCausticPhotons",
        "rsl_causticintensity": "RSL_causticIntensity",
        "rsl_causticphotons": "RSL_causticPhotons",
        "rsl_setinclusive": "RSL_setInclusive",
        "rsl_lightlinking": "RSL_lightLinking",
        "rsl_shadowlinking": "RSL_shadowLinking",
        "folder8": "folder8",
        "rsl_emitgiphotons": "RSL_emitGIPhotons",
        "rsl_giintensity": "RSL_giIntensity",
        "rsl_giphotons": "RSL_giPhotons",
        "light_enable": "light_enable",
        "shadow_type": "shadow_type",
        "gamma0": "gamma0",
        "gamma_override_0": "Gamma_Override_0",
        "tex0_gammaoverride": "tex0_gammaoverride",
        "tex0_srgb": "tex0_srgb",
        "gamma1": "gamma1",
        "gamma_override_3": "Gamma_Override_3",
        "tex1_gammaoverride": "tex1_gammaoverride",
        "tex1_srgb": "tex1_srgb",
    }
    ...
    def __init__(self, node=None, ox_parent=None, node_name=None):
        ...
        self.parm_rs_shadernodemainswitcher = Parameter(
            parm=self.node.parm("RS_shaderNodeMainSwitcher")
        )
        ...
        self.parm_rsl_fliphorizontal = Parameter(
            parm=self.node.parm("RSL_flipHorizontal")
        )
        ...
        self.parm_environment_alpha_channel_replace_2 = Parameter(
            parm=self.node.parm("Environment_Alpha_Channel_Replace_2")
        )
        self.parm_background_enable = Parameter(
            parm=self.node.parm("background_enable")
        )
        self.parm_alphareplaceenable = Parameter(
            parm=self.node.parm("alphaReplaceEnable")
        )
        self.parm_alphareplacevalue = Parameter(
            parm=self.node.parm("alphaReplaceValue")
        )
        self.parm_rs_shadernodemainswitcher_1 = Parameter(
            parm=self.node.parm("RS_shaderNodeMainSwitcher_1")
        )
        ...
        self.parm_applyexposurecompensation = Parameter(
            parm=self.node.parm("applyExposureCompensation")
        )
        ...
        self.parm_shadowtransparency = Parameter(
            parm=self.node.parm("shadowTransparency")
        )
        self.parm_folder2 = Parameter(parm=self.node.parm("folder2"))
        self.parm_rsl_affectdiffuse = Parameter(
            parm=self.node.parm("RSL_affectDiffuse")
        )
        self.parm_rsl_affectspecular = Parameter(
            parm=self.node.parm("RSL_affectSpecular")
        )
        self.parm_rsl_matteshadow = Parameter(parm=self.node.parm("RSL_matteShadow"))
        self.parm_rsl_indirectmaxtracedepth = Parameter(
            parm=self.node.parm("RSL_indirectMaxTraceDepth")
        )
        self.parm_rsl_samples = Parameter(parm=self.node.parm("RSL_samples"))
        self.parm_rsl_volumesamples = Parameter(
            parm=self.node.parm("RSL_volumeSamples")
        )
        self.parm_rsl_diffusescale = Parameter(parm=self.node.parm("RSL_diffuseScale"))
        self.parm_rsl_specularscale = Parameter(
            parm=self.node.parm("RSL_specularScale")
        )
        self.parm_rsl_reflectionscale = Parameter(
            parm=self.node.parm("RSL_reflectionScale")
        )
        self.parm_rsl_transmissionscale = Parameter(
            parm=self.node.parm("RSL_transmissionScale")
        )
        self.parm_rsl_sssscale = Parameter(parm=self.node.parm("RSL_sssScale"))
        self.parm_rsl_multisssscale = Parameter(
            parm=self.node.parm("RSL_multisssScale")
        )
        self.parm_rsl_indirectscale = Parameter(
            parm=self.node.parm("RSL_indirectScale")
        )
        ...
        self.parm_rsl_emitcausticphotons = Parameter(
            parm=self.node.parm("RSL_emitCausticPhotons")
        )
        self.parm_rsl_causticintensity = Parameter(
            parm=self.node.parm("RSL_causticIntensity")
        )
        self.parm_rsl_causticphotons = Parameter(
            parm=self.node.parm("RSL_causticPhotons")
        )
        ...
        self.parm_rsl_shadowlinking = Parameter(
            parm=self.node.parm("RSL_shadowLinking")
        )
        self.parm_folder8 = Parameter(parm=self.node.parm("folder8"))
        self.parm_rsl_emitgiphotons = Parameter(
            parm=self.node.parm("RSL_emitGIPhotons")
        )
        ...
        self.parm_tex0_gammaoverride = Parameter(
            parm=self.node.parm("tex0_gammaoverride")
        )
        ...
        self.parm_tex1_gammaoverride = Parameter(
            parm=self.node.parm("tex1_gammaoverride")
        )
        ...
        self.parm_tex0_colorspace = Tex0ColorspaceMenu(
            parm=self.node.parm("tex0_colorSpace")
        )
        self.parm_tex1 = Tex1Menu(parm=self.node.parm("tex1"))
        self.parm_tex1_colorspace = Tex1ColorspaceMenu(
            parm=self.node.parm("tex1_colorSpace")
        )
        self.parm_backplateaspect = BackplateaspectMenu(
            parm=self.node.parm("backPlateAspect")
        )
        self.parm_rsl_affectedbyrefraction = RslAffectedbyrefractionMenu(
            parm=self.node.parm("RSL_affectedByRefraction")
        )
