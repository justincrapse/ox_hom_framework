...
class BumpmapNode(OXNode):
    ...
    parm_lookup_dict = {
        ...
        "inputb": "inputb",
        "scale": "scale",
        "factorinobjscale": "factorInObjScale",
        "remap_1": "Remap_1",
        "oldrange_min": "oldrange_min",
        "oldrange_max": "oldrange_max",
        "newrange_min": "newrange_min",
        "newrange_max": "newrange_max",
        "unbiasednormalmap": "unbiasedNormalMap",
        "flipy": "flipY",
    ...
    def __init__(self, node=None, ox_parent=None, node_name=None):
        ...
        self.parm_unbiasednormalmap = Parameter(
            parm=self.node.parm("unbiasedNormalMap")
        )
