...
class MaterialNode(OXNode):
    ...
    parm_lookup_dict = {
        ...
        "back_lighting_translucency_1": "Back_lighting/Translucency_1",
        ...
        "refraction_transmission_4": "Refraction/Transmission_4",
    ...
    def __init__(self, node=None, ox_parent=None, node_name=None):
        ...
        self.parm_back_lighting_translucency_1 = Parameter(
            parm=self.node.parm("Back_lighting/Translucency_1")
        )
        ...
        self.parm_refl_reflectivityr = Parameter(
            parm=self.node.parm("refl_reflectivityr")
        )
        self.parm_refl_reflectivityg = Parameter(
            parm=self.node.parm("refl_reflectivityg")
        )
        self.parm_refl_reflectivityb = Parameter(
            parm=self.node.parm("refl_reflectivityb")
        )
        ...
        self.parm_refraction_transmission_4 = Parameter(
            parm=self.node.parm("Refraction/Transmission_4")
        )
        ...
        self.parm_refr_use_base_ior = Parameter(
            parm=self.node.parm("refr_use_base_IOR")
        )
        ...
        self.parm_refr_transmittancer = Parameter(
            parm=self.node.parm("refr_transmittancer")
        )
        self.parm_refr_transmittanceg = Parameter(
            parm=self.node.parm("refr_transmittanceg")
        )
        self.parm_refr_transmittanceb = Parameter(
            parm=self.node.parm("refr_transmittanceb")
        )
        self.parm_refr_absorption_scale = Parameter(
            parm=self.node.parm("refr_absorption_scale")
        )
        self.parm_ss_extinction_coeffr = Parameter(
            parm=self.node.parm("ss_extinction_coeffr")
        )
        self.parm_ss_extinction_coeffg = Parameter(
            parm=self.node.parm("ss_extinction_coeffg")
        )
        self.parm_ss_extinction_coeffb = Parameter(
            parm=self.node.parm("ss_extinction_coeffb")
        )
        self.parm_ss_extinction_scale = Parameter(
            parm=self.node.parm("ss_extinction_scale")
        )
        self.parm_ss_scatter_coeffr = Parameter(
            parm=self.node.parm("ss_scatter_coeffr")
        )
        self.parm_ss_scatter_coeffg = Parameter(
            parm=self.node.parm("ss_scatter_coeffg")
        )
        self.parm_ss_scatter_coeffb = Parameter(
            parm=self.node.parm("ss_scatter_coeffb")
        )
        ...
        self.parm_coat_reflectivityr = Parameter(
            parm=self.node.parm("coat_reflectivityr")
        )
        self.parm_coat_reflectivityg = Parameter(
            parm=self.node.parm("coat_reflectivityg")
        )
        self.parm_coat_reflectivityb = Parameter(
            parm=self.node.parm("coat_reflectivityb")
        )
        ...
        self.parm_coat_transmittancer = Parameter(
            parm=self.node.parm("coat_transmittancer")
        )
        self.parm_coat_transmittanceg = Parameter(
            parm=self.node.parm("coat_transmittanceg")
        )
        self.parm_coat_transmittanceb = Parameter(
            parm=self.node.parm("coat_transmittanceb")
        )
        ...
        self.parm_decoupleiorfromroughness = Parameter(
            parm=self.node.parm("decoupleIORFromRoughness")
        )
        ...
        self.parm_refl_fresnel_mode = ReflFresnelModeMenu(
            parm=self.node.parm("refl_fresnel_mode")
        )
        ...
        self.parm_coat_fresnel_mode = CoatFresnelModeMenu(
            parm=self.node.parm("coat_fresnel_mode")
        )
        self.parm_energycompmode = EnergycompmodeMenu(
            parm=self.node.parm("energyCompMode")
        )
