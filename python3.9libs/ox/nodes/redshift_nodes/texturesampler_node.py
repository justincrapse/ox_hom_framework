...
class TexturesamplerNode(OXNode):
    ...
    parm_lookup_dict = {
        ...
        "offset2": "offset2",
        "rotate": "rotate",
        "color_multiplierr": "color_multiplierr",
        "color_multiplierg": "color_multiplierg",
        "color_multiplierb": "color_multiplierb",
        "color_offsetr": "color_offsetr",
        "color_offsetg": "color_offsetg",
        "color_offsetb": "color_offsetb",
        "alpha_multiplier": "alpha_multiplier",
        "alpha_offset": "alpha_offset",
        "alpha_is_luminance": "alpha_is_luminance",
        "invalid_colorr": "invalid_colorr",
        "invalid_colorg": "invalid_colorg",
        "invalid_colorb": "invalid_colorb",
        "invalid_colora": "invalid_colora",
        "filter_enable_type": "filter_enable_type",
        "filter_bicubic": "filter_bicubic",
        "prefer_sharp": "prefer_sharp",
        "mip_bias": "mip_bias",
    ...
    def __init__(self, node=None, ox_parent=None, node_name=None):
        ...
        self.parm_color_multiplierr = Parameter(
            parm=self.node.parm("color_multiplierr")
        )
        self.parm_color_multiplierg = Parameter(
            parm=self.node.parm("color_multiplierg")
        )
        self.parm_color_multiplierb = Parameter(
            parm=self.node.parm("color_multiplierb")
        )
        ...
        self.parm_alpha_is_luminance = Parameter(
            parm=self.node.parm("alpha_is_luminance")
        )
        ...
        self.parm_filter_enable_type = FilterEnableTypeMenu(
            parm=self.node.parm("filter_enable_type")
        )
